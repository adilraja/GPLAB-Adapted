...
defaults.calcfitness='''computeError''';%regfitness
defaults.precision='12';
defaults.lowerisbetter='1';
defaults.savetofile='''never''';
defaults.operatorprobstype='''variable''';
...
defaults.functions='{''plus'' 2; ''minus'' 2; ''times'' 2; ''sin'' 1; ''cos'' 1; ''adilpower'' 2; ''adildivide'' 2; ''adilsqrt'' 1; ''adillog'' 1; ''adillog2'' 1; ''adillog10'' 1;}';
defaults.terminals='{}';
