function [indfit,indres,data]=testind(indstr,params);
...
% now calc fitness:
if ~isempty(params.datafiley)
   [indfit,indres]=feval(params.calcfitness2,indstr,params,data,state.terminals,state.varsvals);%adil's addition
else
