function tree=maketree(level,oplist,oparity,exactlevel,depthnodes)
%MAKETREE    Creates representation tree for the GPLAB algorithm.
%   MAKETREE(MAXLEVEL,OPERATORS,ARITY,EXACTLEVEL,DEPTHNODES)
...
for i=1:a
   ...
   tree.kids{i}=maketree(newlevel,oplist,oparity,exactlevel,depthnodes);
end
